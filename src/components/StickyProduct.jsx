    ...
    <section className="w-full bg-[#F6F2EC]">
      <div className="mx-auto max-w-7xl px-5 md:px-8 py-12 md:py-16">
        <div className="grid gap-8 lg:gap-12 lg:grid-cols-2">
          {/* LEFT — sticky hero image (square) */}
          <div>
            <div className="lg:sticky lg:top-20">
              <div className="aspect-[4/3] overflow-hidden">
                <img src={LeftHero} alt="Collection" className="h-full w-full object-cover"/>
              </div>
            </div>
          </div>

          {/* RIGHT — 2-column product grid (square cards) */}
                ...
                <div className="relative">
                  <div className="aspect-[4/3] bg-[#EFE8E1] overflow-hidden">
                    <img src={p.img} alt={p.title}
                         className="w-full h-full object-contain transform-gpu will-change-transform transition-transform duration-300 ease-out group-hover:scale-[1.04] group-hover:rotate-[1deg]"
                         loading="lazy"/>
                  </div>
